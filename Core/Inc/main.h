...
#define JOY_NEXT_N_Pin GPIO_PIN_0
#define JOY_NEXT_N_GPIO_Port GPIOB
...
#define ADC_CS_N_Pin GPIO_PIN_12
#define ADC_CS_N_GPIO_Port GPIOB
#define LED_FAIL_Pin GPIO_PIN_13
...
#define JOY_PREVIOUS_N_Pin GPIO_PIN_6
